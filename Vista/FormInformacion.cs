...
namespace Vista
{
    public partial class FormInformacion : Form
    {
        ...
        public FormInformacion(Alumno alumno1)
        {
            ...
            InitializeComponent();
            ActivarMetodosDeCalificacionesPorTriemstre();
        }
        ...
        private void ActivarMetodosDeCalificacionesPorTriemstre()
        {
        ...
        private void ConfigurarDatos()
        {
            ...
            txtGrado.Text = alumno.Grado.NumGrado.ToString();
            ...
            {
                if (respuesta1 == true && respuesta2 == true && respuesta3 == true) // Valido si estan calculados los porcentajes de asistencia.
                {
            ...
            bool estado = controladoraAlumnos.AsignarEstado(alumno);
            if (estado == true)
            {
                txtEstado.Text = alumno.Estado1.ToString();
            }
            else
            {
        ...
        private void btnCalificacionesTrimestre1_Click(object sender, EventArgs e)
        {
            ...
            if (calificacionesTrimestre1 != null)
            {
                ...
                FormCalificacionesTrimestre1 formCalificacionesTrimestre1 = new FormCalificacionesTrimestre1(calificacionesTrimestre1, alumno, 1);
                formCalificacionesTrimestre1.ShowDialog();
            }
            else
            {
        ...
        private void btnCalificacionesTrimestre2_Click(object sender, EventArgs e)
        {
            if (calificacionesTrimestre2 != null)
            {
                // Si se obtienen las calificaciones, se abre el formulario para mostrarlas.
                FormCalificacionesTrimestre2 formCalificacionesTrimestre2 = new FormCalificacionesTrimestre2(calificacionesTrimestre2, alumno, 2);
                formCalificacionesTrimestre2.ShowDialog();
            }
            else
            {
        ...
        private void btnCalificacionesTrimestre3_Click(object sender, EventArgs e)
        {
            ...
            {
                // Si se obtienen las calificaciones, se abre el formulario para mostrarlas.
                FormCalificacionesTrimestre3 formCalificacionesTrimestre3 = new FormCalificacionesTrimestre3(calificacionesTrimestre3, alumno, 3);
                formCalificacionesTrimestre3.ShowDialog();
            }
            else
            {
